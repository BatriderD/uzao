...
public class ProduceWaitDeliverActivity extends BaseActivity implements ProductOrderContract.ProductOrderDetailView {
    ...
    public static void launch(Context context, String orderNo) {
        Intent intent = new Intent(context, ProduceWaitDeliverActivity.class);
    ...
    protected void initView() {
        setContentView(R.layout.activity_product_order_detail_produce_wait_deliver);
        mTitle.setText("订单详情");
