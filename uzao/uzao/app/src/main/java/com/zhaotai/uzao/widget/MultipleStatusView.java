...
public class MultipleStatusView extends RelativeLayout {
    ...
    public MultipleStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mEmptyViewResId = a.getResourceId(R.styleable.MultipleStatusView_emptyView, R.layout.vw_empty);
        mErrorViewResId = a.getResourceId(R.styleable.MultipleStatusView_errorView, R.layout.vw_error);
        mLoadingViewResId = a.getResourceId(R.styleable.MultipleStatusView_loadingView, R.layout.vw_loading);
        mNoNetworkViewResId = a.getResourceId(R.styleable.MultipleStatusView_noNetworkView, R.layout.vw_no_network_view);
    ...
    public final void showEmpty() {
        showEmpty(mEmptyViewResId, DEFAULT_LAYOUT_PARAMS, null);
    }

    /**
     * 显示空视图
     */
    public final void showEmpty(String emptyText) {
        showEmpty(mEmptyViewResId, DEFAULT_LAYOUT_PARAMS, emptyText);
    }
     ...
     */
    public final void showEmpty(int layoutId, ViewGroup.LayoutParams layoutParams, String emptyText) {
        showEmpty(inflateView(layoutId), layoutParams, emptyText);
    }
     ...
     * @param layoutParams 布局参数
     */
    public final void showEmpty(View view, ViewGroup.LayoutParams layoutParams, String emptyText) {
    ...
    public final void showError(View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (null == mErrorView) {
            mErrorView = view;
            View errorRetryView = mErrorView.findViewById(R.id.error_view_btn);
            if (null != mOnRetryClickListener && null != errorRetryView) {
                errorRetryView.setVisibility(VISIBLE);
    ...
    public final void showError(String message) {
        View view = inflateView(mErrorViewResId);
//        showError(inflateView(mErrorViewResId), DEFAULT_LAYOUT_PARAMS);
        checkNull(view, "Error view is null!");
        mViewStatus = STATUS_ERROR;
        if (null == mErrorView) {
            mErrorView = view;
            View errorRetryView = mErrorView.findViewById(R.id.error_view_btn);
            TextView textError = (TextView) mErrorView.findViewById(R.id.error_view_tv);
            if (null != mOnRetryClickListener && null != errorRetryView) {
                errorRetryView.setVisibility(VISIBLE);
                errorRetryView.setOnClickListener(mOnRetryClickListener);
            }
    ...
    public final void showNoNetwork(View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (null == mNoNetworkView) {
            mNoNetworkView = view;
            View noNetworkRetryView = mNoNetworkView.findViewById(R.id.error_view_btn);
            if (null != mOnRetryClickListener && null != noNetworkRetryView) {
                noNetworkRetryView.setVisibility(VISIBLE);
