...
public class MaterialDiscussCenterBean {
    /**
    ...
    private PageInfo<MaterialDiscussBean> childrenPage;
    private MaterialDiscussBean parent;

    public PageInfo<MaterialDiscussBean> getChildrenPage() {
        return childrenPage;
    }

    public void setChildrenPage(PageInfo<MaterialDiscussBean> childrenPage) {
        this.childrenPage = childrenPage;
    }

    public MaterialDiscussBean getParent() {
        return parent;
    }

    public void setParent(MaterialDiscussBean parent) {
        this.parent = parent;
    }
