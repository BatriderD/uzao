 ...
 * Time: 2017/8/23
 * Created by LiYou
 * Description : 大货 -- 大货样生产中
 */

public class ProduceSampleDeliverActivity extends BaseActivity implements ProductOrderContract.ProductOrderDetailView{
    ...
    public static void launch(Context context, String orderNo) {
        Intent intent = new Intent(context, ProduceSampleDeliverActivity.class);
    ...
    protected void initView() {
        setContentView(R.layout.activity_product_order_detail_produce_sample_deliver);
        mTitle.setText("订单详情");
