...
public class ProduceWaitReceiveLastPayActivity extends BaseActivity implements ProductOrderContract.ProductOrderDetailView {
    ...
    public static void launch(Context context, String orderNo) {
        Intent intent = new Intent(context, ProduceWaitReceiveLastPayActivity.class);
    ...
    protected void initView() {
        setContentView(R.layout.activity_product_order_detail_produce_wait_receive_last_pay);
        mTitle.setText("订单详情");
