 ...
 * Time: 2017/5/23
 * Created by LiYou
 * Description : 我的商品 -- 未发布
 */

public class UnPublishProductFragment extends BaseFragment implements MyProductFragmentContract.View,
    ...
    public static UnPublishProductFragment newInstance() {
        return new UnPublishProductFragment();
    }
    ...
    public void onItemChildClick(BaseQuickAdapter adapter, View view, final int position) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_my_product_bottom_middle_button:
                ...
                break;
            case R.id.tv_my_product_bottom_right_button://立即发布
                showProgressDialog();
