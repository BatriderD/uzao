 ...
 * Time: 2018/1/19
 * Created by LiYou
 * Description :我管理的场景presenter
 */

public class MyScenePresenter extends MySceneContract.Presenter {
    private MySceneContract.View mView;
    private HashMap<String, String> params = new HashMap<>();

    public MyScenePresenter(Context context, MySceneContract.View mView) {
        this.mView = mView;
        mContext = context;
    }
     ...
     */
    @Override
    public void getMyManagerSceneList(final int start, final boolean isLoading) {
        params.put("start", String.valueOf(start));
        params.put("length", "10");
        Api.getDefault().getMyManagerSceneList(params)
