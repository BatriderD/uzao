...
public class UnusedFragment extends BaseFragment implements MyDiscountCouponContract.View, OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    public void initView() {
        ...
        mAdapter = new MyDiscountAdapter();
    ...
    public void initData() {
        showLoading();
        mPresenter.getUnusedDiscountList(0, true);
    }
    ...
    public void onRefresh(@NonNull RefreshLayout refreshLayout) {
        mPresenter.getUnusedDiscountList(0, false);
    }
    ...
    public void onLoadMoreRequested() {
        if (data.hasNextPage) {
            ...
            //加载列表数据
            mPresenter.getUnusedDiscountList(start, false);
        } else {
