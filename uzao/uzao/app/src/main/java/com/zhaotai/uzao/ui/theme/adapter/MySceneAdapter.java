...
public class MySceneAdapter extends BaseRecyclerAdapter<ThemeBean, BaseViewHolder> {

    private boolean showManager = false;

    public MySceneAdapter() {
        super(R.layout.item_my_scene);
    }
    ...
    protected void convert(BaseViewHolder helper, ThemeBean item) {
        ...
        helper.addOnClickListener(R.id.tv_my_scene_editor_manager);
    }
