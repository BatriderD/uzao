 ...
 * Time: 2017/8/23
 * Created by LiYou
 * Description : 打样加大货 -- 打样确认
 */

public class SamplingProduceSampleReceiveActivity extends BaseActivity implements ProductOrderContract.ProductOrderDetailView {
    ...
    public static void launch(Context context, String orderNo, int position, boolean source) {
        Intent intent = new Intent(context, SamplingProduceSampleReceiveActivity.class);
    ...
    protected void initView() {
        setContentView(R.layout.activity_product_order_detail_sampling_produce_receive);
        mTitle.setText("订单详情");
        ...
        AlertDialog alert = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        mPresenter.receiveSampleProduct(orderId,"sampling", getIntent().getIntExtra(EXTRA_KEY_PRODUCT_ORDER_DETAIL_ADAPTER_POSITION,0),source, OrderStatus.WAIT_PRODUCE_RECEIVE);
                    }
                }).create();
        alert.show();
    }
