...
public class ClosedProductOrderFragment extends BaseFragment implements ProductOrderContract.CompleteAndCloseView, BaseQuickAdapter.RequestLoadMoreListener
    ...
    public static ClosedProductOrderFragment newInstance() {
        return new ClosedProductOrderFragment();
    }
    ...
    public void initData() {
        showLoading();
        mPresenter.getCloseProductOrderList(0, true);
    }
...
//            不是第一页 就刷新
    ...
    public void onRefresh() {
        mPresenter.getCloseProductOrderList(0, false);
    }
    ...
    public void onLoadMoreRequested() {
        if (data.hasNextPage) {
            ...
            //加载列表数据
            mPresenter.getCloseProductOrderList(start, false);
        } else {
