...
public class CircleIndicator extends LinearLayout {
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorWidth =
                (int) typedArray.getDimension(R.styleable.CircleIndicator_ci_width, -1);
        mSelectedIndicatorWidth =
                (int) typedArray.getDimension(R.styleable.CircleIndicator_ci_selectd_width, -1);
        mIndicatorHeight =
                (int) typedArray.getDimension(R.styleable.CircleIndicator_ci_height, -1);
        mIndicatorMargin =
                (int) typedArray.getDimension(R.styleable.CircleIndicator_ci_margin, -1);
    ...
    public void setViewPager(ViewPager viewPager, int size) {
        ...
        if (mViewpager != null && mViewpager.getAdapter() != null) {
            ...
            mInternalPageChangeListener.onPageSelected(mViewpager.getCurrentItem() % mSize);
        }
    }
    ...
    public int toRealPosition(int position) {
        int realPosition = (position - 1) % mSize;
        if (realPosition < 0)
            realPosition += mSize;
        return realPosition;
    }
...
//            Log.d("啦啦啦", "onPageSelected: " + position);
//            position = position - 1;
//            if (position == -1) {
//                position = 0;
...
//            }
            ...
            if (position == realPosition || realPosition == mLastPosition)
                return;
...
//                position = 0;
//            }
            if (mViewpager.getAdapter() == null || mSize <= 0) {
                return;
            }
    ...
    private DataSetObserver mInternalDataSetObserver = new DataSetObserver() {
        ...
        public void onChanged() {
            ...
            if (newCount == currentCount) {  // No change
                ...
                mLastPosition = mViewpager.getCurrentItem() % mSize;
            } else {
                mLastPosition = -1;
            }
    ...
    private void createIndicators() {
        ...
        int currentItem = mViewpager.getCurrentItem() % mSize;
    ...
    private void addIndicator(int orientation, @DrawableRes int backgroundDrawableId,
                              Animator animator, boolean selected) {
        ...
        if (selected) {
//            addView(Indicator, mSelectedIndicatorWidth, mIndicatorHeight);
