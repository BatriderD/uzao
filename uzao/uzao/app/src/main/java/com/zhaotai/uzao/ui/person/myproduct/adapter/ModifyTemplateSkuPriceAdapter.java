...
public class ModifyTemplateSkuPriceAdapter extends BaseAdapter {

    private List<TemplateBean.Sku> data;
    private Context context;

    public ModifyTemplateSkuPriceAdapter(List<TemplateBean.Sku> data, Context context) {
        this.data = data;
