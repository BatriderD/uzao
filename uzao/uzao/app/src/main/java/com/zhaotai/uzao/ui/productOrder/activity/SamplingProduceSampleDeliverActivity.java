 ...
 * Time: 2017/8/23
 * Created by LiYou
 * Description : 打样大货 -- 打样生产中
 */

public class SamplingProduceSampleDeliverActivity extends BaseActivity implements ProductOrderContract.ProductOrderDetailView {
    ...
    public static void launch(Context context, String orderNo) {
        Intent intent = new Intent(context, SamplingProduceSampleDeliverActivity.class);
    ...
    protected void initView() {
        setContentView(R.layout.activity_product_order_detail_sampling_produce_deliver);
        mTitle.setText("订单详情");
