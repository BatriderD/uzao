...
public class FilterCategoryAdapter extends BaseQuickAdapter<ProductOptionBean.Cat, BaseViewHolder> {
    ...
    @Override
    protected void convert(BaseViewHolder helper, ProductOptionBean.Cat item) {
