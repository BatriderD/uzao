...
public class PayConfirmOrderFromListActivity extends BaseActivity implements PayConfirmOrderContract.View, View.OnClickListener, BaseQuickAdapter.OnItemChildClickListener {
     ...
     */
    public static void launch(Context context, ArrayList<String> orders, boolean type) {
        Intent intent = new Intent(context, PayConfirmOrderFromListActivity.class);
    ...
    public void showOrderDetail(PayOrderBean payOrderBean) {
        ...
        mPresenter.getCoupons(payOrderBean.payPrice);
        //底部布局
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == 4) {
            ...
            mPayMoney.setText(getString(R.string.need_pay_num, String.valueOf(newPrice)));
        }
        //不使用优惠券
        if (resultCode == 5) {
            discountId = "";
    ...
    public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
        switch (view.getId()) {
            ...
            case R.id.ll_pay_confirm_address:
                AddressFromOrderActivity.launch(PayConfirmOrderFromListActivity.this, position);
                break;
        }
    }
