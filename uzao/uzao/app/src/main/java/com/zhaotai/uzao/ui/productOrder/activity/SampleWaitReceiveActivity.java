...
public class SampleWaitReceiveActivity extends BaseActivity implements ProductOrderContract.ProductOrderDetailView{
    ...
    public static void launch(Context context, String orderNo,int position,boolean source) {
        Intent intent = new Intent(context, SampleWaitReceiveActivity.class);
    ...
    protected void initView() {
        setContentView(R.layout.activity_product_order_detail_sample_wait_receive);
        mTitle.setText("订单详情");
    ...
    public void sampleLogistics() {
        mPresenter.logistics(mContext,getIntent().getStringExtra(EXTRA_KEY_PRODUCT_ORDER_DETAIL_ORDER_ID));
    }
        ...
        AlertDialog alert = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        mPresenter.receiveProduct(orderId,getIntent().getIntExtra(EXTRA_KEY_PRODUCT_ORDER_DETAIL_ADAPTER_POSITION,0),source, OrderStatus.WAIT_PRODUCE_RECEIVE);
                    }
                }).create();
        alert.show();
    }
