...
import com.zhaotai.uzao.view.ui.UILoadingDesignerImageView;
import com.zhaotai.uzao.view.ui.UILoadingImageView;
import com.zhaotai.uzao.view.ui.UILoadingView;
 ...
 * Created by LiYou
 * Description :
 * 提供一个浮层展示在屏幕中间, 一般使用 {@link UITipDialog.Builder} 或 {@link UITipDialog.CustomBuilder} 生成。
 * <ul>
 * <li>{@link UITipDialog.Builder} 提供了一个图标和一行文字的样式, 其中图标有几种类型可选, 见 {@link UITipDialog.Builder.IconType}</li>
...
public class UITipDialog extends Dialog{
    ...
    public UITipDialog(@NonNull Context context) {
        this(context, R.style.UI_TipDialog);
    }

    public UITipDialog(@NonNull Context context, @StyleRes int themeResId) {
    ...
    public static class Builder {
        ...
        public UILoadingImageView loadingImageView;
        /**
         * 不显示任何icon
         */
         ...
         * 显示 Loading 图标
         */
        public static final int ICON_TYPE_DESIGNER_LOADING = -1;
        /**
         * 显示成功图标
         */
        ...
        @IntDef({ICON_TYPE_NOTHING, ICON_TYPE_LOADING, ICON_TYPE_SUCCESS, ICON_TYPE_FAIL, ICON_TYPE_INFO,ICON_TYPE_DESIGNER_LOADING})
        ...
        public UITipDialog create() {
            ...
            switch (mCurrentIconType) {
                case ICON_TYPE_LOADING:
                    loadingImageView = new UILoadingImageView(mContext);
                    ViewGroup.LayoutParams layoutParams = new ViewGroup.LayoutParams((int) (PixelUtil.dp2px(128)), (int) (PixelUtil.dp2px(64)));
                    contentWrap.addView(loadingImageView, layoutParams);
                    break;
                case ICON_TYPE_DESIGNER_LOADING:
                    UILoadingDesignerImageView loadingImageView = new UILoadingDesignerImageView(mContext);
                    ViewGroup.LayoutParams designerLayerParams = new ViewGroup.LayoutParams((int) (PixelUtil.dp2px(128)), (int) (PixelUtil.dp2px(64)));
                    contentWrap.addView(loadingImageView, designerLayerParams);
                    break;
            ...
            if (mTipWord != null && mTipWord.length() > 0) {
                ...
                if (mCurrentIconType != ICON_TYPE_NOTHING) {
                    tipViewLP.topMargin = (int)PixelUtil.dp2px(12,mContext);
                }
                ...
                tipView.setTextColor(ContextCompat.getColor(mContext, R.color.progress_text));
