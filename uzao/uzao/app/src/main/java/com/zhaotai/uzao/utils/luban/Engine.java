...
class Engine {
    ...
    Engine(File srcImg, File tagImg, boolean isDefault, int maxSize) throws IOException {
        if (isJpeg(srcImg)) {
    ...
    File compress() throws IOException {
        ...
        if (isDefault) {
            ...
            options.inSampleSize = calculateInSampleSize(maxSize, maxSize);
        }
        ...
        tagBitmap.compress(Bitmap.CompressFormat.PNG, 50, stream);
        tagBitmap.recycle();
