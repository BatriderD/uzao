 ...
 * Time: 2017/8/23
 * Created by LiYou
 * Description : 打样大货 -- 大货样生产中
 */

public class SamplingProduceProduceSamplingDeliverActivity extends BaseActivity implements ProductOrderContract.ProductOrderDetailView {
    ...
    public static void launch(Context context, String orderNo) {
        Intent intent = new Intent(context, SamplingProduceProduceSamplingDeliverActivity.class);
    ...
    protected void initView() {
        setContentView(R.layout.activity_product_order_detail_sampling_produce_produce_samping_deliver);
        mTitle.setText("订单详情");
