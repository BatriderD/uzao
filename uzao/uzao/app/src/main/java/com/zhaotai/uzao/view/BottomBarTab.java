...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.black));
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.black));
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            ...
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.red));
        } else {
    ...
    public int getUnreadCount() {
        int count = 0;
        if (StringUtil.isEmpty(mTvUnreadCount.getText())) {
            return count;
        }
