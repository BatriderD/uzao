 ...
 * Time: 2017/8/23
 * Created by LiYou
 * Description : 打样加大货 -- 待发货
 */

public class SamplingProduceWaitDeliverActivity extends BaseActivity implements ProductOrderContract.ProductOrderDetailView {
    ...
    public static void launch(Context context, String orderNo) {
        Intent intent = new Intent(context, SamplingProduceWaitDeliverActivity.class);
    ...
    protected void initView() {
        setContentView(R.layout.activity_product_order_detail_sampling_produce_wait_deliver);
        mTitle.setText("订单详情");
