...
public class ArtFontTabAdapter extends BaseQuickAdapter<ArtFontTabBean, BaseViewHolder> {
    private int selected = -1;

    public ArtFontTabAdapter() {
        super(R.layout.item_catch_tab);
    }

    @Override
    protected void convert(BaseViewHolder helper, ArtFontTabBean item) {
        ...
        helper.setText(R.id.tv_tab_name, item.getTopicName());
