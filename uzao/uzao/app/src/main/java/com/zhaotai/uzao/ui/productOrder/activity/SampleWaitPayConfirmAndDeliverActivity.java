 ...
 * Time: 2017/8/23
 * Created by LiYou
 * Description : 打样 -- 待收款  --待发货
 */

public class SampleWaitPayConfirmAndDeliverActivity extends BaseActivity implements ProductOrderContract.ProductOrderDetailView{
    ...
    public static void launch(Context context, String orderNo,String orderType) {
        Intent intent = new Intent(context, SampleWaitPayConfirmAndDeliverActivity.class);
    ...
    protected void initView() {
        setContentView(R.layout.activity_product_order_detail_sample_wait_pay_confirm);
        mTitle.setText("订单详情");
    ...
    public void showProductOrderDetail(ProductOrderDetailBean productOrderDetail) {
        ...
        mOrderState.setText(getIntent().getStringExtra(EXTRA_KEY_PRODUCT_ORDER_DETAIL_ORDER_TYPE));
        //地址
