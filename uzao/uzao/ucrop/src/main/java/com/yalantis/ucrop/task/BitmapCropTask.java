...
public class BitmapCropTask extends AsyncTask<Void, Void, Throwable> {
    ...
    public BitmapCropTask(@NonNull Context context, @Nullable Bitmap viewBitmap, @NonNull ImageState imageState, @NonNull CropParameters cropParameters,
                          @Nullable BitmapCropCallback cropCallback, int sampleSize) {
    ...
    private boolean crop() throws IOException {
        ...
        //计算距离上下左右边框的距离
        left = cropOffsetX * mSampleSize;
        right = (mViewBitmap.getWidth() - cropOffsetX - mCroppedImageWidth) * mSampleSize;
        top = cropOffsetY * mSampleSize;
        bottom = (mViewBitmap.getHeight() - cropOffsetY - mCroppedImageHeight) * mSampleSize;
    ...
    protected void onPostExecute(@Nullable Throwable t) {
        if (mCropCallback != null) {
            if (t == null) {
                ...
                mCropCallback.onBitmapCropped(uri, cropOffsetX, cropOffsetY, mCroppedImageWidth, mCroppedImageHeight, left, right, top, bottom,shouldCrop);
            } else {
